---
title: "Trend Panel: Sleep-Wake VsBaseline Comprehensive"
source: persyst-15-help
section: "Trending"
htmFile: "Trend_Panel__SleepWakeVsBaselineComprehensive.htm"
tags:
  - persyst
  - persyst-help
  - trending
...
# Trend Panel: Sleep-Wake VsBaseline Comprehensive

# **Trend Panel: VsBaseline Sleep-Wake**

The VsBaseline Sleep-Wake
...
**Sleep-Wake State:** The Sleep-Wake trend is displayed as a color-scaled bar: Blue=Sleep, Yellow=Wake, Black=Indeterminate. Click here for details of the Sleep-Wake State trend implementation. 
