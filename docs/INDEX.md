...
| Topic | Canonical | Cross-references |
|---|---|---|
| **Every column of a Research-Trends export** | [`COLUMN_MAP_V10_RESEARCH_TRENDS.csv`](COLUMN_MAP_V10_RESEARCH_TRENDS.csv) · [`.html`](COLUMN_MAP_V10_RESEARCH_TRENDS.html) · [`.json`](COLUMN_MAP_V10_RESEARCH_TRENDS.json) | 301 columns. One row per exported column: I-code, CSV header, MMX instrument, `variable_name`, family, units, power scale, band, region, engine cadence, resolution method, evidence tier. |
| **Every column of the full Research panel** | [`COLUMN_MAP_V10_FULL_RESEARCH_PANEL.csv`](COLUMN_MAP_V10_FULL_RESEARCH_PANEL.csv) · [`.html`](COLUMN_MAP_V10_FULL_RESEARCH_PANEL.html) · [`.json`](COLUMN_MAP_V10_FULL_RESEARCH_PANEL.json) | 4,106 columns — the spectrogram families included. Same schema as above. |

Both are regenerated by `scripts/gen_column_map_v10.py`, which resolves every
